        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card" style="border: 1px solid #adaeb2;">
                    ...
                    <!-- Parecer Auditoria -->
                    <div class="card-body">
                        <h4 class="box-title titulo-auditoria">Parecer Auditoria </h4>
                    </div>

                    <div class="pad-20 card-body--">
                        <div class="form-row">
                            <div class="col-lg-12 pad-bottom-10">
                            ...
                            <div class="col-6">
                                <a href="<?=URL;?>Usuario/listar" class="btn btn-info-2">Aprovar</a>
                            </div>
                            <div class="col-6">
                                <button type="submit" class="btn btn-sucesso float-right ml-3">Rejeitar</button>
                            </div> 
                        </div> 
                    </div>
                    <!-- /Parecer Auditoria -->
