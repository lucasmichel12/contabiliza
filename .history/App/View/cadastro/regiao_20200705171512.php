    ...
    <form class="mt-4 shadow p-3 mb-5 bg-white rounded" action="<?=URL;?>Regiao/inserir" method="POST">
        <div class="form-row">
            <div class="col-lg-6 col-md-6 col-sm-12 pad-bottom-10">
                <input type="text" class="form-control" required placeholder="Região | Ex: São Paulo, Nordeste..." name="descricao">
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 pad-bottom-10">
                <input type="text" class="form-control percentual" placeholder="Percentual de acréscimo" name="percentual">
            </div>
        </div> 
        <div class="form-row">
            <div class="col-lg-6 col-md-6 col-sm-12 pad-bottom-10">
        ...
        <div class="form-row">
            <div class="col-6">
                <a href="<?=URL;?>Regiao/listar" class="btn btn-info-2">Listar Regiões</a>
            </div>
            <div class="col-6">
