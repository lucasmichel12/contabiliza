<div class="content">
    ...
    <form class="mt-4 shadow p-3 mb-5 bg-white rounded" action="<?=URL;?>CentroCusto/insert" method="POST">
        ...
        <div class="form-row">
            <div class="col-8">
                <input type="text" class="form-control" required placeholder="Nome Empresarial ou Fantasia" name="descricao" value="<?=$centrocusto['0']['descricao'];?>">
            </div>
            <div class="col-4">
                <input type="text" class="form-control" placeholder="00.000.000/0000-00" name="cnpj" value="<?=$centrocusto['0']['cnpj'];?>">
            </div>
        </div> 
        <div class="form-row">
