    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <p class="topo-auditoria text center font-600">Despesas por Periodo e Tipo entre <strong><?=$data['periodo']['dataIni'];?></strong> até <strong><?=$data['periodo']['dataFim'];?></strong></p> 
            </li>
