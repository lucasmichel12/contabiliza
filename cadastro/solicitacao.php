...
<div id='accordion'>
    <div class='card'>
        <div class='card-header' id='handing1'>
            <h5 class='mb-0'>
                <button class='btn btn-link' data-toggle='collapse' data-target='#collapse1' aria-expanded='true' aria-controls='collapse1'><strong>Relátorio # <?php echo $viagem->getId(); ?></strong></button>
            </h5>
        </div>
            ...
            <div class='card-body'>
                ...
                <div id='collapse1' class='collapse show' aria-labelledby='heading1' data-parent='#accordion'>
                    <div class='card-body'>
                        ...
                        <!-- ################################## Adicionando as Paradas com um Foreach ################################## -->
                        <div class='card'>
                            <div class='card-header' id='handing1'>
                                <h5 class='mb-0'>
                                    <button class='btn btn-link' data-toggle='collapse' data-target='#collapse1' aria-expanded='true' aria-controls='collapse1'><strong>Paradas # <?php echo $viagem->getId(); ?></strong></button>
                                </h5>
                            </div>
                            <div id='collapse1' class='collapse show' aria-labelledby='heading1' data-parent='#accordion'>
                                <div class='card-body'>
